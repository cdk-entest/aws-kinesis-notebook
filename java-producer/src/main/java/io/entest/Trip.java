...
@JsonPropertyOrder({"id", "vendorId", "pickupDate", "dropoffDate",
    "passengerCount", "pickupLongitude", "pickupLatitude", "dropoffLongitude",
    "dropoffLatitude", "storeAndFwdFlag", "gcDistance", "tripDuration",
...
public class Trip {
  ...
  public String toString() {
    return "trip.Trip{" + "id='" + id + '\'' + ", vendorId=" + vendorId
        + ", pickupDate=" + pickupDate + ", dropoffDate=" + dropoffDate
        + ", passengerCount=" + passengerCount + ", pickupLongitude="
        + pickupLongitude + ", pickupLatitude=" + pickupLatitude
        + ", dropoffLongitude=" + dropoffLongitude + ", dropoffLatitude="
        + dropoffLatitude + ", storeAndFwdFlag=" + storeAndFwdFlag
        + ", gcDistance=" + gcDistance + ", tripDuration=" + tripDuration
        + ", googleDistance=" + googleDistance + ", googleDuration="
        + googleDuration + '}';
  }
